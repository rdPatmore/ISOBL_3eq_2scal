...
C     pForceXFile     :: File containing zonal pressure gradient forcing
C                        for periodic domain
C     pForceYFile     :: File containing merridional pressure gradient forcing 
C                        for periodic domain
...
C     the_run_name    :: string identifying the name of the model "run"
     ...
     &                pLoadFile, pForceXFile, pForceYFile, addMassFile,
     ...
     &                the_run_name
      ...
      CHARACTER*(MAX_LEN_FNAM) pForceXFile
      CHARACTER*(MAX_LEN_FNAM) pForceYFile
...
C                            and statistics ; higher -> more writing
     ...
     &        selectBotDragQuadr,
     &        monitorSelect, debugLevel, verShift
