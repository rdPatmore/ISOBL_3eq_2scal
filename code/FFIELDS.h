...
C     pForceX :: constant addative zonal pressure gradient forcing 
C                Units are          ... 
C     pForceY :: constant addative meridional pressure gradient forcing 
C                Units are          ... 
...
C     EfluxP - p-component of Eliassen-Palm flux vector
      ...
      COMMON /FFIELDS_pForceX/ pForceX
      COMMON /FFIELDS_pForceY/ pForceY
      ...
      _RS  pForceX   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS  pForceY   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
